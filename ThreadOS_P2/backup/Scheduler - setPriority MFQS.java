                    ...
                    try {
                        ...
                        if(this.queue0.size() != 0) {
                            ...
                            if(!first.getTerminated()) {
                                ...
                                synchronized(this.queue0) {
                                    if(current != null && current.isAlive()) {
                                        current.setPriority(4);//Thread taking too long, suspend
                                    }
                            ...
                            if(!first.getTerminated()) {
                                ...
                                if(this.queue0.size() != 0){
                                    current.setPriority(4);//suspend Thread if queue0 !empty
                                    continue;
                                }
                            ...
                            if(!first.getTerminated()) {
                                ...
                                for(int x = 0; x < 4; x++){
                                    ...
                                    if(this.queue0.size() != 0){
                                        current.setPriority(4);//suspend if queue !empty
                                        continue;
                                    }
                                ...
                                synchronized(this.queue2) {
                                    if(current != null && current.isAlive()) {
                                        current.setPriority(4);//thread taken too long, suspend
                                    }
